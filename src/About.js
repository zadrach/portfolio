    ...
    <div className="about-container">
      <div className="about-content">
        ...
        <ul>
          ...
          <li>
            Responsive web design to ensure a seamless experience on all devices
          </li>
          <li>
        ...
        <div className="contact-info">
          ...
          <div className="flex contact-links p-4 rounded-lg">
            <a
              href="https://www.linkedin.com/in/zadrach-caunca-ba2435217/"
              target="_blank"
            ...
            <a href="mailto:zadrachcaunca777@gmail.com" className="icon-link">
